...
import com.safeway.ucrop.callback.BitmapCropCallback;
import com.safeway.ucrop.immersion.CropImmersiveManage;
import com.safeway.ucrop.model.AspectRatio;
import com.safeway.ucrop.util.FileUtils;
import com.safeway.ucrop.util.MimeType;
import com.safeway.ucrop.util.ScreenUtils;
import com.safeway.ucrop.util.SelectedStateListDrawable;
import com.safeway.ucrop.view.CropImageView;
...
public class UCropNewActivity extends AppCompatActivity {
    ...
    protected void setupViews(@NonNull Intent intent) {
        ...
        if (mShowBottomControls) {
            ...
            LayoutInflater.from(this).inflate(R.layout.new_ucrop_controls, wrapper, true);
    ...
    private void setupAspectRatioWidget(@NonNull Intent intent) {
        ...
        for (AspectRatio aspectRatio : aspectRatioList) {
            wrapperAspectRatio = (FrameLayout) getLayoutInflater().inflate(R.layout.new_ucrop_aspect_ratio, null);
